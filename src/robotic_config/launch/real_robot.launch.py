...
def generate_launch_description():
    ...
    robot_description=IncludeLaunchDescription(PythonLaunchDescriptionSource(robot_description_launch))
    ...
    return LaunchDescription([robot_description,move_group,rviz_show,joint_driver])
